...
<li>
    <div class="accordion" id="accordionExample">
        <div>
            <a class="nav-link" data-toggle="collapse" data-target="#app-data-tables" aria-expanded="false" aria-controls="collapseTwo">
            <i class="fal fa-fw fa-table mr-3"></i> App Data
            </a>
            <div id="app-data-tables" class="table-list collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
